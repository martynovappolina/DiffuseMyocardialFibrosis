...
function App() {
  ...
  async function calculate(data) {
    ...
    return <div>
      {result == 1 ? 'Прогнозируется наличие диффузного миокардиального интерстициального фиброза. Вероятность правильного прогноза от 89% до 100%.': 
      'Прогнозируется отсутствие диффузного миокардиального интерстициального фиброза. Вероятность правильного прогноза от 54% до 100%.'}
    </div>
  }
